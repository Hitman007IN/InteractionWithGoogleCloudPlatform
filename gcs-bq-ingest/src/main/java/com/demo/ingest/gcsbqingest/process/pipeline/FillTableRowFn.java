...
/**
 * A {@link DoFn} that fill data into {@link TableRow}s accepted by
 * {@link org.apache.beam.sdk.io.gcp.bigquery.BigQueryIO}. The schemas and
 * headers are passed in as side inputs.
 */
public class FillTableRowFn extends DoFn<KV<String, String[]>, KV<String, TableRow>> {
	...
	public FillTableRowFn(PCollectionView<Map<String, FieldType[]>> schemasView,
	...
	@ProcessElement
	public void fill(@Element KV<String, String[]> in, OutputReceiver<KV<String, TableRow>> out, ProcessContext ctx) {
		...
		for (int i = 0; i < record.length; i++) {
			...
			if (!Strings.isNullOrEmpty(field)) {
				...
				case DOUBLE:
					...
					break;
				// TODO(b/120794993): Skip date/time conversion based on a flag supplied by
				// users.
				case TIME:
