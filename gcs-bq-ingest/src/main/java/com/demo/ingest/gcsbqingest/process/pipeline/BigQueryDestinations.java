...
package com.demo.ingest.gcsbqingest.process.pipeline;
...
/**
 * A {@link DynamicDestinations} used by
 * {@link org.apache.beam.sdk.io.gcp.bigquery.BigQueryIO} to indicate the
 * destination BigQuery table for each record. Each record will be assigned by
 * its URI. The schemas and headers are passed in to construct
 * {@link TableSchema} from {@code
...
public class BigQueryDestinations extends DynamicDestinations<KV<String, TableRow>, String> {
	...
	public BigQueryDestinations(PCollectionView<Map<String, FieldType[]>> schemasView,
			PCollectionView<Map<String, String[]>> headersView, String projectId, String datasetId) {
	...
	public TableDestination getTable(String destination) {
		TableReference tableReference = GcpUtil.getBigQueryTableReference(projectId, datasetId, destination);
