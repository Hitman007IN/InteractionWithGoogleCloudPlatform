...
import com.demo.ingest.gcsbqingest.io.OutputWriter;
import com.demo.ingest.gcsbqingest.io.OutputWriterFactory;
...
/**
 * Decompressor tries to decompress content from an {@link InputReader} and
 * writes decompressed data to a different location.
 */
public class Decompressor {
	...
	/**
	 * Decompresses the content provided by the {@link InputReader} and writes the
	 * decompressed data to a location specified by the {@link OutputWriter}.
	 *
	...
	public List<String> decompress(InputReader reader) throws IOException {
		...
		default:
			...
			throw new RuntimeException(String.format("Reached a branch %s which should not be visited.", algo));
		}
	}
}
