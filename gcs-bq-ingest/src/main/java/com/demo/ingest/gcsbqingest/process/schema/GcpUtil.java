...
public class GcpUtil {
	...
	/**
	 * Instantiates a GCS client. If the credentials is null, then the default one
	 * is used.
	 */
	...
	/**
	 * Opens a file on GCS. If the credentials is null, then the default one is
	 * used.
	 */
	public static ReadableByteChannel openGcsFile(@Nullable GoogleCredentials credentials, String uri) {
	...
	public static TableReference getBigQueryTableReference(String projectId, String datasetId, String uri) {
